...
window.AjaxCart = (function() {
  ...
  cart.prototype.success = function(item) {
    ...
    if (this.showNotice) {
      var htmlVariant = item.variant_title !== null ? '<i class="text-dark">('+item.variant_title+')</i>' : '';
      var htmlAlert = '<div class="media mt-2"><a class="mr-3" href="/cart"><img style="width:50px" class="lazyload" data-src="'+item.image+'"></a><div class="media-body align-self-center"><p class="m-0 font-weight-bold">'+item.product_title+' x '+ item.quantity +'</p>'+htmlVariant+'<div><div>';
